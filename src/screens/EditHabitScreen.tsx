...
type EditHabitScreenProps = NativeStackScreenProps<AppStackParamList, 'EditHabit'>;

export default function EditHabitScreen({ navigation, route }: EditHabitScreenProps) {
    const { habitId } = route.params;
    const { theme } = useTheme();
    const { habits, editHabit, deleteHabit } = useHabits();
            ...
            >
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    <View style={styles.header}>
                        ...
                        <Text style={[theme.typography.h2, { color: theme.colors.text, marginLeft: 16 }]}>Edit Habit</Text>
                    </View>
